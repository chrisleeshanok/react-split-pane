...
var SplitPane = function (_React$Component) {
    ...
    _createClass(SplitPane, [{
        ...
        key: '_forceRecalculateHeight',
        value: function _forceRecalculateHeight() {
            var onDragFinished = this.props.onDragFinished;
            var draggedSize = this.state.draggedSize;
        ...
        key: '_forcePrimaryPaneHeight',
        value: function _forcePrimaryPaneHeight(paneHeight) {
